...
public final class PendingActionDao_Impl implements PendingActionDao {
  ...
  @Override
  public Object getPendingEntityIds(final Continuation<? super List<String>> $completion) {
    final String _sql = "SELECT entityId FROM pending_actions WHERE synced = 0";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    final CancellationSignal _cancellationSignal = DBUtil.createCancellationSignal();
